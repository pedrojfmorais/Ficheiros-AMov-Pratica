...
import pt.isec.ans.rockpaperscissors.GameViewModel.Companion.MOVE_NONE
import pt.isec.ans.rockpaperscissors.GameViewModel.Companion.MOVE_PAPER
import pt.isec.ans.rockpaperscissors.GameViewModel.Companion.MOVE_ROCK
import pt.isec.ans.rockpaperscissors.GameViewModel.Companion.MOVE_SCISSORS
import pt.isec.ans.rockpaperscissors.GameViewModel.Companion.SERVER_PORT
...
class GameActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imgRock = findViewById(R.id.imageRock)
        imgRock.setOnClickListener { model.changeMyMove(MOVE_ROCK) }

        imgPaper = findViewById(R.id.imagePaper)
        imgPaper.setOnClickListener { model.changeMyMove(MOVE_PAPER) }

        imgScissors = findViewById(R.id.imageScissors)
        imgScissors.setOnClickListener { model.changeMyMove(MOVE_SCISSORS) }
